...
return array(
    ...
    'config' => array(
        ...
        'fields' => array(
            ...
            'contact'     => array('type' => 'text', 'label' => 'Contact Person'),
            'address'     => array('type' => 'text', 'label' => 'Full Postal Address'),
            'mail'        => array('type' => 'text', 'label' => 'Email Address'),
            'mail2'       => array('type' => 'text', 'label' => 'Email Address 2'),
            'phone'       => array('type' => 'text', 'label' => 'Telephone'),
            'website'     => array('type' => 'text', 'label' => 'Partner Website'),
