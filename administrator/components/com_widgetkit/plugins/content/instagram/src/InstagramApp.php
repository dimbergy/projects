    ...
    public function fetch($params, $content)
    {
            ...
            || md5(serialize($params)) != $content['hash']) // content settings have changed
        {
            ...
            try {
                ...
                $instagram_user = $this->url_get_contents("https://www.instagram.com/{$params['username']}/?__a=1")['graphql']['user'];

                $variables = json_encode(array('id' => $instagram_user['id'], 'first' => $max_items));
