...
<?php foreach ($items as $key=>$item):	?>
	...
	<h3 class="g-item-title center news-title"><a class="moduleItemCategory" href="<?php echo $item->categoryLink; ?>"><?php echo $item->categoryname; ?></a></h3>
...
<?php endif; ?>
  ...
  <ul class="uk-flex-inline">
    <?php foreach ($items as $key=>$item):	?>
    <li class="uk-width-medium-1-3 uk-width-small-1-1 <?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?>">
      ...
      <?php echo $item->event->K2AfterDisplayContent; ?>
			...
			<?php if($params->get('itemDateCreated')): ?>
				<div class="uk-article-meta date date-bottom">
      <span class="fa fa-calendar">&nbsp;</span><span class="moduleItemDateCreated"><?php echo JHTML::_('date', $item->created, JText::_("d/m/y")); ?></span>
		</div>
      <?php endif; ?>
      ...
      <?php endif; ?>
		...
		<?php if($params->get('itemReadMore') && $item->fulltext): ?>
			<button class="button"><a class="moduleItemReadMore" href="<?php echo $item->link; ?>">
