...
<div id="k2Container" class="itemListView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
  ...
  <div class="g-grid">
      ...
      <div class="filter-container">
        ...
        <ul id="tags" class="uk-nav" data-uk-nav>
          ...
          foreach ($tags as $key => $value) { ?>
            <li data-uk-filter="<?php echo $value ?>"><a href=""><?php echo $value ?></a></li>
          <?php }
          ?>
        </ul>
      </div>
    ...
    <div class="g-block size-80">
      <div class="uk-margin uk-grid-width-1-1 uk-grid-width-small-1-1 uk-grid-width-medium-1-3 uk-grid-width-large-1-4" data-uk-grid="{gutter: 3,controls: '#tags'}" data-uk-grid-match="{target:'.uk-panel', row: true}">
