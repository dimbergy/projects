...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<!-- Item title -->
	<h2 class="itemTitle uk-animation-slide-right">
	...
	<div class="itemBody">
		...
		<!-- Item Image -->
		<div class="itemImageBlock" uk-scrollspy="target: > span; cls:uk-animation-slide-bottom; repeat : true;">
			<span class="itemImage align-right animation-slow">
		...
		<!-- Item introtext -->
		<div class="itemIntroText" uk-scrollspy="cls:uk-animation-slide-bottom; repeat : true;">
		...
		<!-- Item fulltext -->
		<div class="itemFullText" uk-scrollspy="cls:uk-animation-slide-bottom; repeat : true;">
		...
		<!-- Item text -->
		<div class="itemFullText" uk-scrollspy="target: > p;cls:uk-animation-slide-bottom; repeat : true;">
			<?php echo $this->item->introtext; ?>
		</div>
