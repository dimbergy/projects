...
<div class="article group-<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?> <?php echo $tags ?>">
		...
		<div class="article-content">
			...
			<?php if(!empty($xAuthor)) { ?>
				<div class="uk-article-meta author">
					<strong><?php echo JText::_('JAUTHOR');?></strong> <?php echo $xAuthor ; ?>
				</div>
			<?php } ?>
