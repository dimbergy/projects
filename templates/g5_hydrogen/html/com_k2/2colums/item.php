...
foreach ($extraFields as $extrafield) {
	...
	if ($extrafield->alias == 'widgetkit') $wid = $extrafield->value;
}
?>
	...
	<div class="g-grid">
		<div class="g-block size-50">
			...
			<?php
				if (!empty($wid)) {
					// echo $wid;
					echo JHtmlContent::prepare('[widgetkit id="' . $wid . '"]');
				}
			?>
			<!-- Item Image -->
		...
		<div class="g-block size-50 uk-flex-middle uk-flex-column item-content">
			<div class="g-content">
