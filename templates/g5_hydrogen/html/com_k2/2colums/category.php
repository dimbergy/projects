...
<div id="k2Container" class="itemListView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemList">
		...
		<!-- Leading items -->
		<div class="uk-grid experts uk-grid-width-1-3 uk-grid-width-small-1-1  uk-grid-width-medium-1-2 uk-grid-width-large-1-3 grid" data-uk-grid-match="{target:' >.article', row: true}">
