...
class __TwigTemplate_c88ff063f5e270575f19f79d94fb6509e75287f73dec07a79e60f3be20efae9b extends Twig_Template
{
    ...
    <div class=\"g-panes\">
        ...
        if ($this->getAttribute($this->getAttribute($this->getAttribute(($context["particle"] ?? null), "form", array()), "fields", array()), "enabled", array())) {
            // line 30
            echo "                    ";
            $this->loadTemplate("forms/fields/enable/enable.html.twig", "@gantry-admin/modals/particle.html.twig", 30)->display(array_merge($context, array("name" => (($context["prefix"] ?? null) . "enabled"), "field" => $this->getAttribute($this->getAttribute($this->getAttribute(($context["particle"] ?? null), "form", array()), "fields", array()), "enabled", array()), "value" => $this->getAttribute($this->getAttribute($this->getAttribute(($context["item"] ?? null), "options", array()), "particle", array()), "enabled", array()), "default" => 1)));
            // line 31
            echo "                    ";
        }
        // line 32
        echo "                </h4>
                ...
                <div class=\"inner-params\">
                    ";
        // line 35
        $this->loadTemplate("forms/fields.html.twig", "@gantry-admin/modals/particle.html.twig", 35)->display(array_merge($context, array("blueprints" => $this->getAttribute(($context["particle"] ?? null), "form", array()), "data" => ($context["data"] ?? null), "prefix" => ($context["prefix"] ?? null), "skip" => array(0 => "enabled"))));
        // line 36
        echo "                </div>
            </div>
        </div>
        ...
        if (($context["block"] ?? null)) {
            ...
            echo "
                ...
                <div class=\"inner-params\">
                    ";
            // line 47
            $this->loadTemplate("forms/fields.html.twig", "@gantry-admin/modals/particle.html.twig", 47)->display(array_merge($context, array("blueprints" => $this->getAttribute(($context["block"] ?? null), "form", array()), "data" => $this->getAttribute(($context["item"] ?? null), "options", array()), "prefix" => "block.")));
            // line 48
            echo "                </div>
            </div>
        </div>
...
";
    ...
    {
        return new Twig_Source("", "@gantry-admin/modals/particle.html.twig", "C:\\xampp\\htdocs\\zoomin\\administrator\\components\\com_gantry5\\templates\\modals\\particle.html.twig");
    }
}
